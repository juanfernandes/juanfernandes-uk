      ...
      <body>
        <main class="container">
          <div class="content content--slim">
            ...
            <h2>Recent links</h2>
            <p class="u-block"><small>Updated: <time class="dt-published" datetime="2024-05-06T14:43:48Z">2024-05-06T14:43:48Z</time></small></p>

            <ul class="list-bordered"><li>
              <a class="delta u-inline-block u-mb-1" href="https://gomakethings.com/the-web-component-lifecycle-methods/">Web Component lifecycle methods</a>
              <p class="u-mb-0">Yesterday, we learned about the different ways to instantiate a Web Component. In the article, I mentioned the connectedCallback() lifecycle method. Today,…</p>
            </li>
            <li>
              <a class="delta u-inline-block u-mb-1" href="https://chrisburnell.com/note/slash-interests/">What are you interested in?</a>
              <p class="u-mb-0">You may or may not be aware of the /about, /ideas, /now, and /uses page initiatives[1] [2], where website authors are encouraged to create pages on their…</p>
            </li>
            <li>
              ...
              <p class="u-mb-0">As part of this ongoing series on Web Components, we’ve created our first Web Component, learned how to add options and settings, and learned how to…</p>
            </li>
            <li>
              <a class="delta u-inline-block u-mb-1" href="https://adactio.com/journal/21078">My approach to HTML web components</a>
              <p class="u-mb-0">I’ve been deep-diving into HTML web components over the past few weeks. I decided to refactor the JavaScript on The Session to use custom elements wherever it…</p>
            </li>
            <li>
              <a class="delta u-inline-block u-mb-1" href="https://gomakethings.com/progressively-enhancing-a-web-component/">Progressively enhancing a Web Component</a>
              <p class="u-mb-0">This week, we’ve looked at how Web Components are different from React, how to create your first Web Component, and how to add options to a Web Component.…</p>
            </li>
            <li>
              <a class="delta u-inline-block u-mb-1" href="https://minutestomidnight.co.uk/blog/json-rss-feed/">JSON RSS feed I quickly created a JSON feed for this website</a>
              <p class="u-mb-0">While setting up Echo Feed to mirror my blog posts on the fediverse, I’ve discovered…</p>
            </li>
            <li>
              <a class="delta u-inline-block u-mb-1" href="https://adamsilver.io/blog/dont-use-the-maxlength-attribute-to-stop-users-from-exceeding-the-limit/">Don’t use the maxlength attribute to stop users from exceeding the limit</a>
              <p class="u-mb-0">Have you heard of the “error prevention” heuristic? It means “do everything you can so users don’t make mistakes”. And it’s good advice. But some…</p>
            </li>
            <li>
              <a class="delta u-inline-block u-mb-1" href="https://www.codeflood.net/blog/2024/04/17/11ty-nested-pagination/">Eleventy Nested Pagination</a>
              <p class="u-mb-0">Eleventy (the cool static site generator) has a great feature called Pagination which allows you to iterate over a list of things in chunks and…</p>
            </li>
            <li>
              <a class="delta u-inline-block u-mb-1" href="https://flamedfury.com/posts/deploying-an-11ty-project-to-shared-hosting/">Deploying An 11ty Project To Shared Hosting</a>
              <p class="u-mb-0">When discussing hosting options for personal websites, the usual suspects are mentioned: Netlify,…</p>
            </li>
            <li>
              <a class="delta u-inline-block u-mb-1" href="https://gomakethings.com/adding-options-to-your-web-component/">Adding options to your Web Component</a>
              <p class="u-mb-0">Yesterday, we learned how to create your first Web Component. Today, we’ll learn how to add options and settings. Let’s dig in! Our Web Component We’ve got our…</p>
            </li>
            <li>
              <a class="delta u-inline-block u-mb-1" href="https://gomakethings.com/your-first-web-component/">Your first Web Component</a>
              <p class="u-mb-0">Yesterday, we talked about why Web Components won’t replace React or Vue. Today, let’s look at how to create your first Web Component. Let’s dig in! A really…</p>
            </li>
            <li>
              <a class="delta u-inline-block u-mb-1" href="https://css-irl.info/recreating-the-his-dark-materials-logo-in-css/">Re-creating the ‘His Dark Materials’ Logo in CSS</a>
              <p class="u-mb-0">I love the new BBC adaptation of Philip Pullman’s His Dark Materials trilogy of novels. There’s also some pretty nice graphic design to appreciate. I’m a sucker…</p>
            </li>
            <li>
              <a class="delta u-inline-block u-mb-1" href="https://gomakethings.com/will-web-components-replace-react-and-vue/">Will Web Components replace React and Vue?</a>
              <p class="u-mb-0">Over the weekend, I sent an email to my newsletter subscribers asking them what kinds of things they’d like to learn about Web Components. One of the most…</p>
            </li>
            <li>
